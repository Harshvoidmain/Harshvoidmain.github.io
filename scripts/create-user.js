...
async function createSmita() {
  ...
  try {
    ...
    const facultyDocRef = db.collection('faculty').doc(uid); // Wait, usually faculty collection doc ID is a separate auto-id or user UID
    // Actually in our AddFacultyPage, it's an auto-generated id or customId. We will just use uid for simplicity.
    await facultyDocRef.set({
      ...
      phone: "+91 9876543210",
      address: "Mumbai",
      departmentId: "001", // Assuming Computer Science
    ...
    console.log('Faculty profile created in Firestore faculty collection.');
    process.exit(0);
