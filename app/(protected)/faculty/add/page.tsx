...
const DEPARTMENTS = [
  { id: "001", name: "Computer Science & Engineering" },
  { id: "002", name: "Information Technology" },
  { id: "003", name: "Mechanical Engineering" },
  { id: "004", name: "Civil Engineering" },
  { id: "005", name: "Electrical Engineering" },
  { id: "006", name: "Electronics & Communication" },
  { id: "007", name: "Chemical Engineering" },
  { id: "008", name: "Master of Computer Applications" },
  { id: "009", name: "Master of Business Administration" },
  { id: "010", name: "Physics" },
  { id: "011", name: "Mathematics" },
  { id: "012", name: "English" },
];
