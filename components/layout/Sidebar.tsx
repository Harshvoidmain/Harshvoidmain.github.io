...
const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    roles: ["faculty"],
    children: [
      { label: "Publications", href: "/faculty/me/publications", icon: BookOpen, roles: ["faculty"] },
      { label: "Research", href: "/faculty/me/research", icon: FlaskConical, roles: ["faculty"] },
      { label: "Awards", href: "/faculty/me/awards", icon: Trophy, roles: ["faculty"] },
      { label: "Workshops", href: "/faculty/me/workshops", icon: Wrench, roles: ["faculty"] },
      { label: "Patents", href: "/faculty/me/patents", icon: Cpu, roles: ["faculty"] },
      { label: "Memberships", href: "/faculty/me/memberships", icon: Handshake, roles: ["faculty"] },
      { label: "Contributions", href: "/faculty/me/contributions", icon: ScrollText, roles: ["faculty"] },
      { label: "Interactions", href: "/faculty/me/interactions", icon: ClipboardList, roles: ["faculty"] },
      { label: "Financial Support", href: "/faculty/me/financial-support", icon: DollarSign, roles: ["faculty"] },
    ],
  },
  {
    label: "Students",
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between h-16 px-4 border-b border-border shrink-0">
        ...
        {collapsed && (
          <div className="w-7 h-7 rounded bg-primary flex items-center justify-center text-white font-heading font-bold text-xs mx-auto">
            IMS
          </div>
        )}
        <button
          onClick={onToggle}
          className={cn(
            "p-1 rounded-md text-muted hover:text-[rgb(var(--text-primary))] hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors",
            collapsed && "hidden"
          )}
        >
